...
public class MainPage extends Application {
    ...
    // Variables used for the single instance of the application
    private final Button loginButton = new Button("Login");
    private final Label usernameLabel = new Label("Username:");
    private final Label passwordLabel = new Label("Password:");
    private final TextField usernameTextField = new TextField();
    private final PasswordField passwordTextField = new PasswordField(); // Use PasswordField instead of TextField
    private final Label welcome = new Label("Welcome to the BookStore App!\n"); // Bold text label
    private final Label welcome2 = new Label();

    private final Button ownerBooks = new Button("Books");
    private final Button ownerCustomers = new Button("Customers");
    private final Button logOut = new Button("Logout");

    private final Label customersLabel = new Label("Customers");
    private final Label booksLabel = new Label("Books");

    // ObservableLists to store Books and SetCustomer objects
    private final ObservableList<Books> booksTableData = FXCollections.observableArrayList();
    private final ObservableList<SetCustomer> customerTableData = FXCollections.observableArrayList();
    private final Button back = new Button("Back");
    private final Button del = new Button("Delete");
    private final Button buy = new Button("Buy");
    private final Button redeemAndBuy = new Button("Redeem points and Buy");
    ...
    public void start(Stage primaryStage) {
        ...
        welcome.setFont(Font.font("Arial", FontWeight.BOLD, 13));

        //Sets up the booksTableData and customerTableData arrayList to have data from the text files books.txt amd customers.txt
        try {
            FileReader temp2;
            Scanner temp3;
            try (FileReader temp = new FileReader("books.txt")) {
                temp2 = new FileReader("customers.txt");
                Scanner temp1 = new Scanner(temp);
                temp3 = new Scanner(temp2);
        ...
        ownerCustomers.setOnAction( // If the owner wants to see the ownerCustomer page it is displayed
                (ActionEvent e) -> {
        ...
        primaryStage.setOnCloseRequest((WindowEvent e) -> {
            try {
                ...
                try ( // Saves the Books object and SetCustomer object data to the text files
                    ...
                    temp2 = new FileWriter("customers.txt");
    ...
    public GridPane ownerBooks() { // Returns the ownerBooks pane
        ...
        addButton.setOnAction((ActionEvent e) -> {
                ...
                } // When the add button is pressed a new Books object is created based on the parameters passed
        );
        ...
        del.setOnAction((ActionEvent e) -> {
                ...
                } // When the delete button is pressed the selected book is deleted from the arraylist
        );
    ...
    public GridPane ownerCustomers() { // Returns the ownerCustomers pane
        ...
        TableView<SetCustomer> customersTable = new TableView<>();
        hb = new HBox();
        hb2 = new HBox();
        ...
        del.setOnAction((ActionEvent e) -> {
                ...
                } // If the delete button is pressed the selected customer is deleted
        );
    ...
    public GridPane customersStartScreen() { // Returns the customerStartScreen pane
        GridPane temp = new GridPane(); // Variables needed to create the pane
        TableView<Books> customerBuyTable = new TableView<>();
        hb = new HBox();
        totalCost = 0;
        ...
        welcome2.setText("Welcome " + customerTableData.get(customerIndex).getUsername() + ". " +
                "You have " + customerTableData.get(customerIndex).getPoints() + " points. Your satus is " +
        ...
        select.setCellValueFactory((CellDataFeatures<Books, Boolean> p) -> p.getValue().getSelect() // Changes the value of the select booleabn value in the Books object to show that the customer wants to buy it
        );
